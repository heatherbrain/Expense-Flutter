...
import 'package:flutter_second/widgets/chart/chart_bar.dart';
...
class Chart extends StatelessWidget {
  ...
  List<ExpenseBucket> get buckets {
    return [
      ...
      ExpenseBucket.forCategory(expenses, Category.item),
      ExpenseBucket.forCategory(expenses, Category.weapon),
    ];
  }
